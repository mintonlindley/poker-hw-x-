...
Mehna Lakshminarayanan: Mehna wrote the full implementations of TexasHoldemGame.java and ChecksHand.java, creating the GUI framework and hand-evaluation logic for Texas Hold’em. Other than the card and back of card image implementations of TexasGameWindow.java, Mehna wrote TexasGameWindow.java. She also worked with Lindley on Betting.java and Rules.java helping integrate across both Blackjack and Texas Hold’em. In addition, Mehna assisted with connecting the card image system to the Texas Hold’em logic. 

HOW TO RUN!!!
cd ~/poker-hw-x--main 
javac -d bin src/*.java
cp -r images bin/
java -cp bin CasinoApp
